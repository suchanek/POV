...
#declare xcamera_normal = camera {
        location <0, 80, -200> // -250
        direction <0, 0, 2.2>
        up <0, 1, 0>
...
#declare pipe_png = union {
 object {az2 rotate <30, 0, 90> translate <-15, 3, 0> }
...
//  object {MAIN_DRAIN_egs rotate <-30,0,-90> translate <38, -90, 20> scale <.75, .75, .75> }
  object {MAIN_DRAIN_egs rotate <-30,0,-90> translate <30, -80, 30> scale <.75, .75, .75> }
}
...
object {png_pipe_drain translate <-10, -30, 50> }
