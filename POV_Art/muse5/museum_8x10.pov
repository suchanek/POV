...
object { MyTree scale <.5, .75, .5> translate <205, 0, 45> }
...
object {bowl translate <50, 23, 62>     }
object {bowl rotate z*180 translate <50, 56.5, 62>     }
object {obj_DNA_Cartoon        scale .45  translate <50, 30, 60>  }
