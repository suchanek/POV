...
#declare cliptext = union {
            object {leadertext translate <-28, 52, 0> }           
	    object {throughtext translate <-20, 40, 0> }    	    
	}
#declare award_union = union {
 	  object {award_hex}
//	  object {png_logo_disk_rot translate <0, -32, -41>}
   	  object {base translate <0, -90, 0>}
	  object {peppertext translate <-18, -2, -39> }  
//	  object {leadertext translate <-32, 45, -3> }           
//	  object {throughtext translate <-20, 31, -23> }
	  
//          object {obj_DNA_Cartoon scale 2.25  translate <0, -75, 0> }
}
