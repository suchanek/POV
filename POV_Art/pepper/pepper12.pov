...
#version 3.0
global_settings { assumed_gamma 2.2 max_trace_level 10} // 13
...
#declare ofront_face = object {
  box {
	<-22.5, -90, -39>, <22.5, 11, -38>
   texture {T_Grnt3}                       // T_Vicksbottle_Glass
  }   
}
...
#declare award_union = union {
	  ...
	  object {yeartext translate <-16, -9, -40> }  // -69
          object {leadertext translate <-17, -25, -40> }           
