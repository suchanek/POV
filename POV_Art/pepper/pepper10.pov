...
#version 3.0
global_settings { assumed_gamma 1.8 max_trace_level 13}
...
light_source { <100.0, 500.0, -500.0> colour rgb <.6,.6,.6> }
...
#declare myfinish =   finish { reflection .8 specular 1 ambient .2 metallic M}
...
#declare award_union = union {
	  ...
	  object {peppertext translate <-19, 0, -39> }  
	  object {yeartext translate <-16, -9, -39> }  // -69
          object {leadertext translate <-16.5, -25, -39> }           
	  object {throughtext translate <-10, -33, -39> } 
	  object {authenttext translate <-19, -41, -39> }   	    
}
