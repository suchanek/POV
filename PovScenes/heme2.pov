...
// 100 100 n 1
// File:E:\EGS\PovScenes\heme2.pov
...
#declare Surf_tex = texture { pigment { colour red 0.000 green 0.000 blue 0.000 filter 0.500} finish{ metallic }}
#declare N_tex = texture { pigment { colour red 0.231 green 0.318 blue 1.000 } finish{ ATM_FINISH }}
...
#declare P_tex = texture { pigment { colour red 1.000 green 0.659 blue 0.078 } finish{ ATM_FINISH }}
#declare H_tex = texture { pigment { colour red 0.290 green 0.800 blue 1.000 } finish{ ATM_FINISH }}
#declare S_tex = texture { pigment { colour red 1.000 green 0.929 blue 0.000 } finish{ ATM_FINISH }}
#declare X_tex = texture { pigment { colour red 0.624 green 0.624 blue 0.624 } finish{ ATM_FINISH }}
#declare SSBnd_tex = texture { pigment { colour red 1.000 green 0.929 blue 0.000 } finish{ ATM_FINISH }}
#declare HBnd_tex = texture { pigment { colour red 0.000 green 1.000 blue 0.000 filter 0.5} finish{ ATM_FINISH }}
#declare WkHBnd_tex = texture { pigment { colour red 0.561 green 0.678 blue 0.561 filter 0.5} finish{ ATM_FINISH }}
...
// ----- 1hbg -----
object{ A0_shape }   // ILE137
object{ A1_shape }   // SER138
object{ A2_shape }   // GLY139
object{ A3_shape }   // ALA140
object{ A4_shape }   // LEU141
object{ A5_shape }   // ILE142
object{ A6_shape }   // SER143
object{ A7_shape }   // GLY144
object{ A8_shape }   // LEU145
object{ A9_shape }   // GLN146
object{ A10_shape }   // SER147
object{ A11_shape }   // HEM148

//************ CAMERA *********

camera { location < 0, 0, -133.8>  // get closer to <0,0,0> to zoom in on the model
