...
#if (DO_LENTICULAR)
 #declare theta = .5 * slope + half_ang + initial_ang;     // equation for theta as a fxn of clock
#else 
...
object {
  light_source {
     <0,0, -20.039>
     color Gray40   // gray40 shadowless
...
#declare risedronate_text = object {
 text
 {
  ...
  "Actonel Approved 4/14/2000",   // the string to create
...
#declare rised_labeled = union {
  ...
  object { risedronate_text translate <-12, -15.5, -1> }
