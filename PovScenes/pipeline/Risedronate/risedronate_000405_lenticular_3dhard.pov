...
#declare ASPECT =  0.769; // 0.714 = 5x7, 0.769 = 10x13
...
#declare T_Atom_O =
 texture{pigment{color Firebrick} finish{ambient 0.3 diffuse 0.6 crand 0.03}}
...
#declare T_Atom_P =
 texture{pigment{color Yellow} finish{ambient 0.3 diffuse 0.6 crand 0.03}}
 texture{T_Grnt22 scale <1.5, 0.7, 0.5> rotate <0, 0, 40>}
 texture{T_Grnt20a scale <2.5, 2, 0.5> rotate <0, 0, -50>}
 texture{T_Crack4 scale <0.7, 1, 1> rotate <10, 0, -20> finish{phong 1.0 phong_size 90}
}            
...
object {
  light_source {
     <0,5, -20.039>
     color Gray10   // gray40 shadowless
