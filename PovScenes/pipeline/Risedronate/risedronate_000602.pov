...
#declare ThreeByFour = 3/4;
#declare TwoByThree = 2/3;


#declare ASPECT =  ThreeByFour; // 0.714 = 5x7, 0.769 = 10x13
...
#declare rised_orient = object {risedronate_bs rotate 90*z translate -.25 * y}
#declare rised_orient2 = object {rised_orient rotate <0, -14.5, -5>}
#declare rised_orient3 = object {rised_orient rotate <10, 0, 0>}
#declare rised_orient4 = object {rised_orient rotate <10, -10, 0>}


#declare rised_labeled_2x3 = union {
  object {         rised_orient4
                   rotate <0, 0, 0>       // -14.5
                   translate <0,.2,0>
                   scale 2.5
                   }
  object { risedronate_text translate <-5, -16.5, -1> }
  object { png_text translate <-5.5, 12.5, -0> }
}                                    

#declare rised_labeled_3x4 = union {
  object {         rised_orient4
                   rotate <0, 0, 0>       // -14.5
                   translate <0,.2,0>
                   scale 2.6
                   }
  object { risedronate_text translate <-5, -15.5, -3.25> }
  object { png_text translate <-5.5, 12.5, -0> }
}                                    

#if (ASPECT = ThreeByFour)
 object {rised_labeled_3x4}
#else
 object (rised_labeled_2x3)
#end
...
#declare BOGUS = true;
  ...
  #include "egs_sig.inc"
  #declare egs_sig_2x3 = 
     object { egstext  scale <.35,.35,.35>
           rotate <10, 1, 0> translate <6.75, -13.7, -5.5>
     }
     
  #declare egs_sig_3x4 = 
     object { egstext  scale <.35,.35,.35>
           rotate <10, 1, 0> translate <7.2, -13.7, -5.5>
     }
     #if (ASPECT = ThreeByFour)    
       object {egs_sig_3x4}
     #else
