...
#declare Surf_tex = texture { pigment { colour red 0.000 green 0.000 blue 0.000 filter 0.900} finish{ metallic }}
#declare N_tex = texture { pigment { colour red 0.227 green 0.318 blue 1.000 } finish{ ATM_FINISH }}
#declare C_tex = texture { pigment { colour red 0.502 green 0.502 blue 0.502 } finish{ ATM_FINISH }}
#declare O_tex = texture { pigment { colour red 1.000 green 0.000 blue 0.000 } finish{ ATM_FINISH }}
#declare P_tex = texture { pigment { colour red 1.000 green 0.659 blue 0.075 } finish{ ATM_FINISH }}
#declare H_tex = texture { pigment { colour red 1.000 green 1.000 blue 1.000 } finish{ ATM_FINISH }}
#declare S_tex = texture { pigment { colour red 1.000 green 0.925 blue 0.000 } finish{ ATM_FINISH }}
#declare X_tex = texture { pigment { colour red 0.624 green 0.624 blue 0.624 } finish{ ATM_FINISH }}
#declare SSBnd_tex = texture { pigment { colour red 0.000 green 0.000 blue 0.000 } finish{ ATM_FINISH }}
#declare HBnd_tex = texture { pigment { colour red 0.000 green 0.000 blue 0.000 filter 0.5} finish{ ATM_FINISH }}
#declare WkHBnd_tex = texture { pigment { colour red 0.000 green 0.000 blue 0.000 filter 0.5} finish{ ATM_FINISH }}
#declare Clash_tex = texture { pigment { colour red 0.000 green 0.000 blue 0.000 filter 0.5} finish{ ATM_FINISH }}

// ------ Bonds radii ---------

#declare rRIBN = 0.06   // flat Ribbon radius
#declare rEDM = 0.04   // EDM cylinder radius
#declare r_Atm = 0.400   // atom radius
...
// ---- Radius for "joining" atoms ----
 #declare VDW_factor = 0.400   // changing this value will alter the radius of "joining" atoms
...
// ----- 8Iso_Estradiol -----
object{ A0_shape }   // UNK1  

//************ CAMERA *********

camera { location < 0, 0, -20.5>  // get closer to <0,0,0> to zoom in on the model
